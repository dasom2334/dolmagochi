...
const WX = {
  ...
  // 장대비 — 거실 창(generate.js rainDrops 5·4·5, 덮임 ≈13%)과 같은 밀도로 맞춘다.
  // 처음엔 가까운 겹을 간격 4·길이 8·4겹·불투명 1로 뿌려 화면의 40% 가 흰 기둥이
  // 됐고, 다리와 돌이 묻혀 비가 아니라 커튼으로 읽혔다(플레이테스트).
  // 덮임 = 겹수×길이 / (간격×TILE_H): 먼 겹 8%×.5 + 가까운 겹 10%×.9 ≈ 13%.
  downpour: [...streaks(5, 4, 3, 154, 0, 0.5),
    ...streaks(5, 5, 3, 156, 0, 0.9)],
