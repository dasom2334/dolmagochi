...
export function lampArt() {
  return [
    R(50, 23, 5, 1, '#8a6a3a'), R(49, 24, 6, 2, '#6e5230'), R(49, 26, 6, 1, '#4e3a22'),
    R(51, 26, 3, 1, '#c9a86a'), R(52, 27, 1, 8, '#4a4150'),
...
export function lampGlowArt() {
  return [
    R(51, 26, 3, 2, '#fff1c0'),
    R(49, 25, 7, 5, '#ffd98a', 0.5),
    R(46, 23, 13, 9, '#ffcf80', 0.24),
    R(43, 21, 19, 13, '#ffc266', 0.1),
